...
|**timeToSettle** | **Integer** | The duration from transaction initiation to its complete and successful execution, including the final, irreversible recording of its outcome. |  |
