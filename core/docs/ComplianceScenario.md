...
|------------ | ------------- | ------------- | -------------|
|**contractId** | [**ContractId**](ContractId.md) | Contract reference for which compliance requirements apply. |  |
...
|**status** | **ComplianceScenarioStatus** | Current compliance fulfillment status for this contract scenario. |  |
