...
processing while maintaining strict compliance standards.
  ...
  For more information, please visit [https://definancy.com](https://definancy.com)
...
```xml
<dependency>
  <groupId>com.definancy</groupId>
  <artifactId>definancy-sdk-java</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'definancy-sdk-java' jar has been published to maven central.
    mavenLocal()       // Needed if the 'definancy-sdk-java' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "com.definancy:definancy-sdk-java:1.0.0-SNAPSHOT"
  }
```
...
- `target/definancy-sdk-java-1.0.0-SNAPSHOT.jar`
- `target/lib/*.jar`
